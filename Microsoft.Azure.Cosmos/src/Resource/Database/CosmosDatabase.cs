...
namespace Microsoft.Azure.Cosmos
{
    ...
    public abstract class CosmosDatabase
    {
        ...
        /// </para>
        /// </remarks>
        public abstract Task<DatabaseResponse> ReadDatabaseAsync(
        ...
        /// </code>
        /// </example>
        public abstract Task<DatabaseResponse> DeleteDatabaseAsync(
                    RequestOptions requestOptions = null,
                    CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// </returns>
        public abstract Task<CosmosResponseMessage> ReadDatabaseAsStreamAsync(
                    RequestOptions requestOptions = null,
                    CancellationToken cancellationToken = default(CancellationToken));
        ...
        public abstract Task<CosmosResponseMessage> DeleteDatabaseAsStreamAsync(
                    RequestOptions requestOptions = null,
                    CancellationToken cancellationToken = default(CancellationToken));
    }
}
