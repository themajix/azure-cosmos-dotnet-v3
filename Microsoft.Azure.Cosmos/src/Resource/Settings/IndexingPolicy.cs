...
namespace Microsoft.Azure.Cosmos
{
    ...
    public class IndexingPolicy 
    {
        ...
        public virtual IndexingMode IndexingMode { get; set; }
        ...
        public virtual Collection<IncludedPath> IncludedPaths { get; set; } = new Collection<IncludedPath>();
        ...
        public virtual Collection<ExcludedPath> ExcludedPaths { get; set; } = new Collection<ExcludedPath>();
        ...
        public virtual Collection<Collection<CompositePath>> CompositeIndexes { get; set; } = new Collection<Collection<CompositePath>>();

        /// <summary>
        /// Collection of spatial index definitions to be used
        /// </summary>
        [JsonProperty(PropertyName = Constants.Properties.SpatialIndexes)]
        public virtual Collection<SpatialPath> SpatialIndexes { get; set; } = new Collection<SpatialPath>();
