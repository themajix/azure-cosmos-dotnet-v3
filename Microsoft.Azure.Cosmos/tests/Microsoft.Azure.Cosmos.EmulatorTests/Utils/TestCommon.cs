...
namespace Microsoft.Azure.Cosmos.SDK.EmulatorTests
{
    ...
    internal static class TestCommon
    {
        ...
        public static async Task DeleteAllDatabasesAsyncWorker(CosmosClient client)
        {
            ...
            CosmosFeedIterator<CosmosDatabaseSettings> resultSetIterator = client.Databases.GetDatabasesIterator(maxItemCount: 10);
        ...
        public static async Task DeleteDatabaseCollectionAsync(CosmosClient client, CosmosDatabase database)
        {
            ...
            CosmosFeedIterator<CosmosContainerSettings> resultSetIterator = database.Containers.GetContainersIterator(maxItemCount: 10);
            while (resultSetIterator.HasMoreResults)
            {
                ...
                foreach (CosmosContainerSettings container in await resultSetIterator.FetchNextSetAsync())
                {
                    ...
                    deleteCollectionTasks.Add(TestCommon.AsyncRetryRateLimiting(() => database.Containers[container.Id].DeleteContainerAsync()));
                }
